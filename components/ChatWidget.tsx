...
const chatResponses: Record<string, string> = {
  ...
  "How do I sign up and claim my spot?": "Two easy steps! First, <a href='https://pflugervilleventurefest.com/etn/day-1-marketing-that-moves/' target='_blank' class='text-white font-bold underline hover:opacity-80'>📅 Register for Pfest</a> to secure your event spot. Then visit business.moilapp.com and sign up instantly with Google, email, or phone number - no long forms! Once you're in, confirm you're a Pfest attendee and you're all set! <a href='https://business.moilapp.com' target='_blank' class='text-white font-bold underline hover:opacity-80'>🚀 Claim Your Moil Access</a>",
